  ...
  content: [
    {
      ...
      vietnamese:
        "ユニット１５では、許可の求め方、禁止表現、継続状態、および特定の動詞と助詞の使い方を学びます。",
    },
...

    {
      ...
      vietnamese:
        "「〜てもいいです」は、何かをしてもよいか尋ねたり、許可を与えたりする時に使います。",
    },

    {
      ...
      vietnamese:
        "質問：V（て形）+ も いいですか｜許可：V（て形）+ も いいです",
    },
...

    {
      ...
      vietnamese:
        "「〜ています」は進行中の動作だけでなく、継続状態、職業、習慣も表します。",
    },

    {
      ...
      vietnamese:
        "状態結果：動作の結果が現在も続く｜習慣・職業：繰り返し行う活動",
    },

    {
      ...
      examples: [
        ...
        {
          japanese:
            "わたしは パワーでんきで コンピューターを つくって います。",
          vietnamese:
            "Tôi làm nghề sản xuất máy tính tại công ty Power Electric.",
...

    {
      ...
      vietnamese:
        "助詞「に」は、「はいります」「のります」「すわります」などの動詞と一緒に使われます。",
    },

    {
      ...
      vietnamese:
        "代表的な動詞：はいります（入る）、のります（乗る）、すわります（座る）",
    },
...

    {
      ...
      vietnamese:
        "助詞「に」は、物や人が行動の結果として置かれる場所を示します。",
    },
...

    {
      ...
      vietnamese:
        "パターン1：V（て形）+ も いいですか｜パターン2：V（て形）+ は いけません｜パターン3：V（て形）+ います｜パターン4：場所 に + 移動動詞｜パターン5：場所 に 物 を V",
    },
