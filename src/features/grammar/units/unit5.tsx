  ...
  content: [
    {
      ...
      vietnamese:
        "ユニット５では、移動動詞、方向助詞、および誰とどこに行くかについて学びます。",
    },
    {
      type: "title",
    ...
    },
    {
      ...
      vietnamese:
        "じょし「へ」（「え」と発音）は、移動の方向または目的地を示します。「N（場所）へ V」という形式で使われます。",
    },
    {
      type: "example",
      examples: [
    ...
    },
    {
      ...
      vietnamese:
        "このパターンは「どこへも行きません」という意味です。「どこ」は「どこへも」に置き換わり、否定の意味になります。",
    },
    {
      type: "example",
      examples: [
    ...
    },
    {
      ...
      vietnamese:
        "じょし「で」は、交通手段を示します。徒歩の場合は「あるいて」を使用します。",
    },
    {
      type: "example",
      examples: [
    ...
    },
    {
      ...
      vietnamese:
        "じょし「と」は、人または動物との「一緒に」を意味します。一人でする場合は「ひとりで」を使用します。",
    },
    {
      type: "example",
      examples: [
        {
          japanese:
            "あした わたしは あさ 9じに ともだちと ぎんこうへ いきます。",
          vietnamese: "Ngày mai sáng lúc 9 giờ tôi sẽ đi ngân hàng với bạn.",
          english:
            "Tomorrow morning, I will go to the bank with a friend at 9 AM.",
        },
        {
    ...
    },
    {
      ...
      vietnamese:
        "いつ（いつ）は、行動がいつ発生するかを尋ねるために使用されます。「に」助詞は必要ありません。",
    },
    {
      type: "example",
      examples: [
