import type { VocabularyItem, CreateVocabularyDto, UpdateVocabularyDto, CustomList, ListItem } from './vocabulary';
import type { IVocabularyStorage } from './IVocabularyStorage';
import { generateId, getCurrentTimestamp } from '../flashcards/flashcardHelpers';
